...
import { default as ReactSticky } from 'react-sticky-el';

interface StickyProps extends React.HTMLAttributes<HTMLElement> {
  /**
...
/**
 * ENRG-43 Ampol Sticky Component Wrapper for react-sticky-el library
 * @param children JSX children
 */
const Sticky = ({ children, ...props }: StickyProps) => {
  // Fixes issue with sticky element not being aligned correctly on first render
  // (likely an issue introduced internally by react-sticky-el)
  useEffect(() => {
